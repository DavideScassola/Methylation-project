---
title: "MSR and expression for K562 genes"
...
```{r, include=FALSE}
meth_data_file <- "../../../Rexperiments/K562_genes_msr_table.Rda"
rna_file <- "../../../MethylationCode/MethylationData/rna-seq/ENCFF156DDL_K562(wgbs_related)_polyA.tsv"
...
```{r, echo=FALSE, warning=FALSE}
ggscatter(data_table[rows, ], "CG_list_msr", response_variable)
```
...
```{r, echo=FALSE}
check_model <- function(train_model_data, test_model_data, response_variable, predictors, summary = T, model_out = F)
{
...
wgbs <- sum_strands(readRDS("../../../MethylationCode/MethylationData/wgbs/K562.Rda"), verbose = T)
```
