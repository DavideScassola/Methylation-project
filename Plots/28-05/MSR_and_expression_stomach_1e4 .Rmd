...
hist(abs(prediction-actual), main = "Error distribution compared with data", breaks = 100, xlab= "prediction-actual", probability = T, col = alpha(5, 0.7))
...
model_data = (data_table[gene_presence, c(to_predict, basic_predictors, "gene_count")])
...
```{r, echo=FALSE}
model_data = (data_table[gene_presence, c(to_predict, basic_predictors, msr_predictors, "gene_count", "genes_nucleotides_count")])
