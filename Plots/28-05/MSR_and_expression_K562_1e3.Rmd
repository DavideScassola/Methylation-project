---
title: "MSR and expression for K562, windows of 1000 sites"
...
```{r, include=FALSE}
setwd(dir = "../../../")
rna <- read_rna_file("MethylationCode/MethylationData/rna-seq/K562.tsv")
#data <- sum_strands(readRDS("MethylationCode/MethylationData/wgbs/K562.Rda"))
msr_fragments_table = fragments_table
rna_fragment_tables = readRDS("Rexperiments/K562_rna_fragment_tables.Rda")
wsize = 1
#########################
```
...
```{r, echo=FALSE}
chart.Correlation(data_table[,c(essentials, "msr_density")])
```
